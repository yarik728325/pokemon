...
import {Request,Loading,Filters} from "../../actions";
...
class Filter extends Component{
    ...
    render(){
        const {normal,fighting,flying,poison,ground,rock,bug,ghost,steel,fire, water,grass,electric,psychic,ice,dragon,dark,fairy,unknown,shadow} = this.props;
        return(
          <>
            <div className = "my">
                    <ListGroup as="ul" >
